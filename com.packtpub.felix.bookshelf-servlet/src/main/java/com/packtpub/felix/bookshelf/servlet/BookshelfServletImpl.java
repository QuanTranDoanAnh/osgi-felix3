...
public class BookshelfServletImpl extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5727939780251450466L;
	...
	private void htmlCategories(PrintWriter printWriter) throws InvalidCredentialsException, BookInventoryNotRegisteredRuntimeException, SessionNotValidRuntimeException {
		htmlTop(printWriter);

		printWriter.println("<h3>Categories:</h3>");
		printWriter.println("<ul>");
		for (String category : this.service.getCategories(this.sessionId)) {
			printWriter.println("<li><a href=\"" + browseByCategoryUrl(category) + "\">" + category + "</li>");
		}
		printWriter.println("</ul>");
	...
	private void htmlByCategory(PrintWriter printWriter, String category) throws InvalidCredentialsException, BookNotFoundException, SessionNotValidRuntimeException, BookInventoryNotRegisteredRuntimeException {
		htmlTop(printWriter);
	...
	private void htmlByAuthor(PrintWriter printWriter, String author) throws InvalidCredentialsException, BookNotFoundException, SessionNotValidRuntimeException, BookInventoryNotRegisteredRuntimeException {
		htmlTop(printWriter);
