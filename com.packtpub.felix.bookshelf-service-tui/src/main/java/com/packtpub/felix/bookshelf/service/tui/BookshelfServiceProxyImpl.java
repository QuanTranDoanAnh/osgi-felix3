...
public class BookshelfServiceProxyImpl implements BookshelfServiceProxy {
	...
	public Set<Book> search(@Descriptor("username") String username, @Descriptor("password") String password,
			...
			@Descriptor("upper rating limit (inclusive)") int upper) throws SessionNotValidRuntimeException,
			InvalidCredentialsException, BookNotFoundException, BookInventoryNotRegisteredRuntimeException {
	...
	private Set<Book> getBooks(String sessionId, BookshelfService service, Set<String> results)
			throws SessionNotValidRuntimeException, BookInventoryNotRegisteredRuntimeException {
