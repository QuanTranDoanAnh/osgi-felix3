...
public class BookshelfServiceProxyImpl implements BookshelfServiceProxy
{
    ...
    public final String add(@Descriptor("username") String username,
        ...
        throws InvalidCredentialsException, BookAlreadyExistsException, InvalidBookException, BookInventoryNotRegisteredRuntimeException, SessionNotValidRuntimeException
    {
    ...
    public final Set<Book> search(
        ...
        throws InvalidCredentialsException, BookNotFoundException, SessionNotValidRuntimeException, BookInventoryNotRegisteredRuntimeException
    {
        BookshelfService service = lookupService();
    ...
    private Set<Book> getBooks(String sessionId, BookshelfService service, Set<String> results) throws SessionNotValidRuntimeException, BookInventoryNotRegisteredRuntimeException {
